...
/**
 * Botão "Enviar Notificacao" para RespAcoesCorretivas (05. Ações Corretivas)
 */
@ActionButton(
    description = "Enviar Notificacao",
    instanceName = "RespAcoesCorretivas",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class EnviarNotificacaoRespAcoesCorretivas implements AcaoRotinaJava {
