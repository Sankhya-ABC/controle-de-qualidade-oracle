...
/**
 * Botão "Enviar Notificacao" para RespRiscosOportunidades (07. Riscos e Oportunidades)
 */
@ActionButton(
    description = "Enviar Notificacao",
    instanceName = "RespRiscosOportunidades",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class EnviarNotificacaoRespRiscosOportunidades implements AcaoRotinaJava {
