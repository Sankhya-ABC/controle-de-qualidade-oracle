...
/**
 * Botão de ação "Mudar Fase" para 4.Avaliação de Riscos das Ações
 */
@ActionButton(
    description = "Mudar Fase",
    instanceName = "MudancaAvaliacaoRisco",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class MudarFaseAvaliacaoRiscos implements AcaoRotinaJava {
