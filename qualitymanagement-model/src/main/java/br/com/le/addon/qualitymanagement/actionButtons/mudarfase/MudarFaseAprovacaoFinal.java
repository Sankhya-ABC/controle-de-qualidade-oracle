...
/**
 * Botão de ação "Mudar Fase" para 5.Aprovação da Proposta de Mudança
 */
@ActionButton(
    description = "Mudar Fase",
    instanceName = "AvaliacaoPosMudanca",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class MudarFaseAprovacaoFinal implements AcaoRotinaJava {
