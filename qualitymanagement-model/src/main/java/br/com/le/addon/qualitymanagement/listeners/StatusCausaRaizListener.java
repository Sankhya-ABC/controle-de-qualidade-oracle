...
@Listener(instanceNames = {"DadosCausaRaiz"})
public class StatusCausaRaizListener extends PersistenceEventAdapter {

    private static final String TABELA = "TGQCAUSARAIZ";
    private static final String CAMPO_ID = "IDCAUSARAIZ";
