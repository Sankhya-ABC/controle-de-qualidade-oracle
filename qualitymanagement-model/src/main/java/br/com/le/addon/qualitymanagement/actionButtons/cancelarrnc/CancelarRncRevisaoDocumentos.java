...
/**
 * Botão de ação "Cancelar RNC" para 06. Revisão de Documentos
 */
@ActionButton(
    description = "Cancelar RNC",
    instanceName = "RevisaoDocumentos",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class CancelarRncRevisaoDocumentos implements AcaoRotinaJava {
