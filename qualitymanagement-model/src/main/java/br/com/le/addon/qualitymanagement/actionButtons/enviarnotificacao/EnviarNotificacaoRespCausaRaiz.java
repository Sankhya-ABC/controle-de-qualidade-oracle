...
/**
 * Botão "Enviar Notificacao" para RespCausaRaiz (03. Causa Raiz)
 */
@ActionButton(
    description = "Enviar Notificacao",
    instanceName = "RespCausaRaiz",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class EnviarNotificacaoRespCausaRaiz implements AcaoRotinaJava {
