...
@Listener(instanceNames = {"DadosAcoesImediatas"})
public class StatusAcoesImediatasListener extends PersistenceEventAdapter {

    private static final String TABELA = "TGQACOESIMEDIATAS";
