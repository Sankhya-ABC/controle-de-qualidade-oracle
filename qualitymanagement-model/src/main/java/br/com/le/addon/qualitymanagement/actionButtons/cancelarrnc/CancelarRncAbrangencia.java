...
/**
 * Botão de ação "Cancelar RNC" para 04. Abrangência da Não Conformidade
 */
@ActionButton(
    description = "Cancelar RNC",
    instanceName = "Abrangencia",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class CancelarRncAbrangencia implements AcaoRotinaJava {
