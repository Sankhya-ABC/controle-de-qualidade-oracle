...
/**
 * Botão "Enviar Notificacao" para RespImplementacao (08. Implementação)
 */
@ActionButton(
    description = "Enviar Notificacao",
    instanceName = "RespImplementacao",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class EnviarNotificacaoRespImplementacao implements AcaoRotinaJava {
