...
/**
 * Botão de ação "Cancelar RNC" para 07. Riscos e Oportunidades
 */
@ActionButton(
    description = "Cancelar RNC",
    instanceName = "RiscosOportunidades",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class CancelarRncRiscosOportunidades implements AcaoRotinaJava {
