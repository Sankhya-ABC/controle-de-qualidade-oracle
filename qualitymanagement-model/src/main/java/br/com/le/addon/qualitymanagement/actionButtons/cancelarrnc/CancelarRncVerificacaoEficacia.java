...
/**
 * Botão de ação "Cancelar RNC" para 10. Verificação de Eficacia
 */
@ActionButton(
    description = "Cancelar RNC",
    instanceName = "VerificacaoEficacia",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class CancelarRncVerificacaoEficacia implements AcaoRotinaJava {
