...
/**
 * Botão "Enviar Notificacao" para RespRevisao (06. Revisão de Documentos)
 */
@ActionButton(
    description = "Enviar Notificacao",
    instanceName = "RespRevisao",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class EnviarNotificacaoRespRevisao implements AcaoRotinaJava {
