...
/**
 * Botão "Enviar Notificacao" para RespAcaoImediata (02. Ações Imediatas)
 */
@ActionButton(
    description = "Enviar Notificacao",
    instanceName = "RespAcaoImediata",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class EnviarNotificacaoRespAcaoImediata implements AcaoRotinaJava {
