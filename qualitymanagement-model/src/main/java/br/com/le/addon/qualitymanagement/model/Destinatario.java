...
public class Destinatario {
    ...
    public void setParametros(BigDecimal nunota, BigDecimal pedidoTray) throws Exception {
        ...
        if (pedidoTray != null) {
            ...
            sql.appendSql(" UF.UF,");
            sql.appendSql(" SUBSTR(DESTINATARIO.TELEFONE, 3, LENGTH(DESTINATARIO.TELEFONE)) AS TELEFONE,");
            sql.appendSql(" NVL(DESTINATARIO.FAX,SUBSTR(DESTINATARIO.TELEFONE, 3, LENGTH(DESTINATARIO.TELEFONE))) AS FAX,");
