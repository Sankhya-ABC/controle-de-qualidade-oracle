...
/**
 * Botão de ação "Mudar Fase" para 2.Questionário de Avaliação da Mudança
 */
@ActionButton(
    description = "Mudar Fase",
    instanceName = "MudancaQuestionarioAvaliacao",
    accessControlled = false,
    transactionType = TransactionType.AUTOMATIC,
    refreshType = RefreshTypeEnum.PARENT_ITEM)
public class MudarFaseMudancaQuestionario implements AcaoRotinaJava {
